...
const _BASE_NODE_LIBRARY = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        keywords: ['expression', 'expr', 'wiggle', 'driver', 'link'],
        factory: (pos) => ({
          id: uid('node'),
          type: 'ebnNode',
          position: pos,
          data: {
            ...
            inputs: [
              ...
              { id: 'layer',      label: 'Layer',      type: 'text' },
              { id: 'property',   label: 'Property',   type: 'text', placeholder: 'ADBE Opacity' },
              { id: 'expression', label: 'Expression', type: 'text', placeholder: 'wiggle(2, 30)' },
            ],
            outputs: [{ id: 'exec_out', label: 'Execution' }],
            values: { property: 'ADBE Opacity', expression: 'wiggle(2, 30)' },
          },
        }),
      },
      {
        ...
        keywords: ['keyframe', 'key', 'setvalueattime', 'animate'],
        factory: (pos) => ({
          id: uid('node'),
          type: 'ebnNode',
          position: pos,
          data: {
            ...
            inputs: [
              ...
              { id: 'layer',    label: 'Layer',     type: 'text' },
              { id: 'property', label: 'Property',  type: 'text',   placeholder: 'ADBE Opacity' },
              { id: 'time',     label: 'Time (s)',  type: 'number', placeholder: '0' },
              { id: 'value',    label: 'Value',     type: 'number', placeholder: '0' },
            ],
            outputs: [{ id: 'exec_out', label: 'Execution' }],
            values: { property: 'ADBE Opacity', time: 0, value: 100 },
          },
        }),
      },
      {
        ...
        keywords: ['keyframe', 'key', 'removekey', 'delete'],
        factory: (pos) => ({
          id: uid('node'),
          type: 'ebnNode',
          position: pos,
          data: {
            ...
            inputs: [
              ...
              { id: 'layer',    label: 'Layer',      type: 'text' },
              { id: 'property', label: 'Property',   type: 'text',   placeholder: 'ADBE Opacity' },
              { id: 'index',    label: 'Key Index',  type: 'number', placeholder: '1' },
            ],
            outputs: [{ id: 'exec_out', label: 'Execution' }],
            values: { property: 'ADBE Opacity', index: 1 },
          },
        }),
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        type: 'readValueAtTime',
        label: 'Read Value at Time',
        keywords: ['value', 'time', 'valueattime', 'sample', 'read'],
        factory: (pos) => ({
          id: uid('node'),
          type: 'ebnNode',
          position: pos,
          data: {
            ...
            values: { property: 'ADBE Opacity', time: 0 },
          },
        }),
      },
      {
